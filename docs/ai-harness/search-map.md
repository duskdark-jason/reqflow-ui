...
| MCP 管理 | 人员 MCP Key、明文 Key 渲染安装命令、多客户端交互安装命令和配置复制 | `docs/ai-harness/modules/requirement-platform.md` | `src/views/requirement/mcpKey/index.vue`、`src/api/requirement/mcpKey.js` |
