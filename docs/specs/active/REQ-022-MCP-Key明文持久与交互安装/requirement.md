...
- 需求详情页 `closeout_pending` 阶段不应同时展示“生成合并归档指令”和“确认归档完成”；平台归档验证通过前只展示生成合并归档指令，验证通过后才展示确认归档完成。
...
- 需求详情页合并归档阶段按平台归档验证结果，在生成合并归档指令和确认归档完成按钮之间切换。
- 文档和静态检查同步防回归。
...
- 合并归档入口展示：是，合并归档指令与确认归档完成入口按平台归档验证结果互斥。
- 返修流程展示：是，提交返修必须先填写问题说明并展示在 Review 报告上下文。
