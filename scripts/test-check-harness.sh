...
make_root() {
  ...
  printf '%s\n' '# meta' '' '- 状态：executing' '- 当前角色：Execution Agent' '- 当前分支：feature/demo' '- companion 仓库：无' > "$root/docs/specs/active/2026-06-09-REQ-001-演示需求/meta.md"
...
make_root "$root"
printf '%s\n' '# meta' '' '- 状态：unknown' '- 当前角色：Execution Agent' '- 当前分支：feature/demo' '- companion 仓库：无' > "$root/docs/specs/active/2026-06-09-REQ-001-演示需求/meta.md"
expect_fail "$root" complete "invalid spec status" "状态"

make_root "$root"
printf '%s\n' '# meta' '' '- 状态：planning' '- 当前角色：Execution Agent' '- 当前分支：feature/demo' '- companion 仓库：无' > "$root/docs/specs/active/2026-06-09-REQ-001-演示需求/meta.md"
...
printf '%s\n' '# meta' '' '- 状态：review' '- 当前角色：Review Agent' '- 当前分支：feature/demo' '- companion 仓库：无' > "$root/docs/specs/active/2026-06-09-REQ-001-演示需求/meta.md"
expect_fail "$root" review "invalid review conclusion" "Review 结论必须"

make_root "$root"
printf '%s\n' '# execution' '' '## 验证结果' '' '- AC-001 命令：sh test.sh' > "$root/docs/specs/active/2026-06-09-REQ-001-演示需求/execution-report.md"
printf '%s\n' '# meta' '' '- 状态：complete' '- 当前角色：Execution Agent' '- 当前分支：feature/demo' '- companion 仓库：无' > "$root/docs/specs/active/2026-06-09-REQ-001-演示需求/meta.md"
...
make_root "$root"
printf '%s\n' '# execution' '' '## 验证结果' '' '- AC-001 命令：sh test.sh' > "$root/docs/specs/active/2026-06-09-REQ-001-演示需求/execution-report.md"
printf '%s\n' '# meta' '' '- 状态：planning' '- 当前角色：Plan Agent' '- 当前分支：feature/demo' '- companion 仓库：无' > "$root/docs/specs/active/2026-06-09-REQ-001-演示需求/meta.md"
...
printf '%s\n' '# review' '' '## Review 结论' '' '- 结论：通过' '' '- AC-001：通过' > "$root/docs/specs/active/2026-06-09-REQ-001-演示需求/review-report.md"
printf '%s\n' '# meta' '' '- 状态：complete' '- 当前角色：Execution Agent' '- 执行模式：隔离开发模式' '- 当前分支：feature/demo' '- companion 仓库：无' > "$root/docs/specs/active/2026-06-09-REQ-001-演示需求/meta.md"
